...
# System: Playlist Inline Markups
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text=_["S_B_9"], # "الجميع" أو مفتاح مخصص لقائمتي
...
def warning_markup(_):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["SA_B_3"], # "إجمالي" أو مفتاح للحذف النهائي
                callback_data="delete_whole_playlist"
            ),
        ],
        [
            InlineKeyboardButton(
                text=_["BACK_BUTTON"], callback_data="del_back_playlist"
            ),
            InlineKeyboardButton(
                text=_["CLOSE_BUTTON"], callback_data="close"
            ),
